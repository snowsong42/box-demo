...
| --------- | -------- | ---- | ---------------------------------------------------- |
| ✅ 已有   | TFT      | -    | 接线和驱动完全一致                                   |
| ✅ 已实现 | 按键     | 低   | 4 键 (UP/DOWN/LEFT/RIGHT)，复用 DIJI-NES 方向键 GPIO |
| ✅ 已实现 | I2S 音频 | 中   | MAX98357A (GPIO 4/5/6)，WAV 循环播放                 |
...
| **按键**        | 8 键直连 GPIO                              | 4 键 (UP=17,DOWN=3,LEFT=8,RIGHT=18) | ✅ 已实现 (方向键子集) |
| **音频**        | MAX98357A (I2S0: 5,4,6)                    | MAX98357A (I2S0: 5,4,6)             | ✅ 已实现              |
